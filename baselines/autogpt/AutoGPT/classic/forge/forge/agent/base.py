...
class BaseAgentSettings(SystemSettings):
    ...
    total_cost: Optional[float] = Field(description="The total cost that this agent has incurred", default=None)
    total_input_tokens: Optional[int] = Field(description="Total input tokens for the run", default=None)
    total_output_tokens: Optional[int] = Field(description="Total output tokens for the run", default=None)
