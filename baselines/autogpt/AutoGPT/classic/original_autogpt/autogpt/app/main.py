...
async def run_auto_gpt(
    ...
    try:
        ...
        agent.file_manager.agent_state.total_cost = agent.llm_provider._budget.total_cost
        agent.file_manager.agent_state.total_input_tokens = agent.llm_provider._budget.usage.prompt_tokens
        agent.file_manager.agent_state.total_output_tokens = agent.llm_provider._budget.usage.completion_tokens
